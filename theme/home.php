...
/// 01   HERO SECTION
---------------------------------->
<section class="relative hero-news top-0 h-96 bg-green-dark flex justify-center items-center overflow-hidden">
    <!------------ PAGE TITLE ------------>
    <div class="max-w-lg mx-auto px-4">
        <div class="flex flex-col gap-6 text-center text-white">
            <h2 class="capitalize font-bold text-4xl md:text-5xl leading-tight md:leading-snug">latest news</h2>
        </div>
    </div>
</section>
<!-------------------------------- 
